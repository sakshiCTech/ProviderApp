...
class ServiceItem extends StatelessWidget {
  ...
  const ServiceItem({Key key, this.historyModel}) : super(key: key);
              ...
              children: [
                ClipRRect(
                  ...
                  child: CachedNetworkImage(
                    ...
                    width: 80,
                    fit: BoxFit.cover,
                    imageUrl: historyModel.staticMap,
                  ...
                  Container(
                    width: 80,
                    child: Text(historyModel.payment.providerPay.toString(),
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      Text(DateFormat('HH:mm').format(DateTime.parse(historyModel.createdAt)),
                          maxLines: 1,
                          ...
                          textAlign: TextAlign.center,
                          overflow: TextOverflow.fade),
                      Text(DateFormat('dd').format(DateTime.parse(historyModel.finishedAt)),
                          maxLines: 1,
                          ...
                          textAlign: TextAlign.center,
                          overflow: TextOverflow.fade),
                      Text(DateFormat('MMM').format(DateTime.parse(historyModel.createdAt)),
                          maxLines: 1,
                          style: Get.textTheme.bodyText2.merge(
                            TextStyle(color: Get.theme.primaryColor, height: 1),
                          ),
