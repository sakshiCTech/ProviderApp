                          ...
                          content: Column(
                            children: [
                              BookingRowWidget(
                                  ...
                                  child: Align(
                                    alignment: Alignment.centerRight,
                                    child: Ui.getPrice(40.0, style: Get.textTheme.subtitle2),
                                  ),
                                  hasDivider: true),
                              Column(
                                children: List.generate(2, (index) {
                                  ...
                                  return BookingRowWidget(
                                      ...
                                      child: Align(
                                        alignment: Alignment.centerRight,
                                        child: Ui.getPrice(2.0, style: Get.textTheme.bodyText1),
                                      ),
                                      hasDivider: 2 == index);
                                }),
                              ),
                              ...
                              Obx(() {
                                return BookingRowWidget(
                                  ...
                                  child: Align(
                                    alignment: Alignment.centerRight,
                                    child: Ui.getPrice(3.0, style: Get.textTheme.headline6),
                                  ),
                                );
                              }),
                            ],
